        ...
        <nav className="mt-2">
          <ul className="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
            <li className={`nav-item ${isDashboardOpen ? 'menu-open' : ''}`}>
              <a href="#" className={`nav-link ${isDashboardOpen ? 'active' : ''}`} onClick={toggleDashboardMenu}>
              ...
              <ul className={`nav nav-treeview ${isDashboardOpen ? 'd-block' : 'd-none'}`}>
            ...
            <li className={`nav-item ${isPropertyOpen ? 'menu-open' : ''}`}>
              <a href="#" className={`nav-link ${isPropertyOpen ? 'active' : ''}`} onClick={togglePropertyMenu}>
                <i className="bi bi-house-add-fill"></i>
                <p>
                  Property
                  <i className={`nav-arrow bi ${isPropertyOpen ? 'bi-chevron-down' : 'bi-chevron-right'}`} />
                </p>
              </a>
              <ul className={`nav nav-treeview ${isPropertyOpen ? 'd-block' : 'd-none'}`}>
                <li className="nav-item">
